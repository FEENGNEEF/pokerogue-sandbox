  ...
  private initDexData(): void {
    ...
    for (const species of speciesDataRegistry.getAllSpecies()) {
      data[species.speciesId] = {
        // Sandbox edition: every obtainable form, shiny, variant, and nature is ready to use.
        seenAttr: species.getFullUnlocksData(),
        caughtAttr: species.getFullUnlocksData(),
        natureAttr: (1 << 25) - 2,
        seenCount: 0,
        caughtCount: 1,
        hatchedCount: 0,
